...
- **SQLite over PostgreSQL** — zero setup overhead, sufficient for this scope. In production I'd swap to PostgreSQL without changing much code.
...
|----------|-------|-------|
| Performance | B | SQLite is fast for this scale. No caching implemented. |
